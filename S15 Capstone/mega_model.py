...
class Mynet(BaseModel):
    ...
    def __init__(self, path=None, features=256, non_negative=True, inference=False, classes=4, img_size = (416, 416)):
        ...
        self.conv_1_2 = nn.Sequential(
            ...
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
            nn.Conv2d(256, 128, kernel_size=1, stride=1, padding=0, bias=False), ## module_list.110.Conv2d.weight torch.Size([128, 256, 1, 1])
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True),
        ...
        self.conv_2_2 = nn.Sequential(
            ...
            nn.BatchNorm2d(512),
            nn.ReLU(inplace=True),
            nn.Conv2d(512, 256, kernel_size=1, stride=1, padding=0, bias=False), ## module_list.98.Conv2d.weight torch.Size([256, 512, 1, 1])
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
